			        ...
			        <div class="container">
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                ...
			                <li class=" smooth-menu active"></li>
								...
								<li class="smooth-menu"><a href="#ajouter">Ajouter</a></li>
							    <li class=" smooth-menu"><a href="#liste">liste</a></li>
								<li class="button">
					...
					<table class="table table-hover bg-dark">
						...
						<thead class="text-white">
							...
							<tr class="text-center tablecolor">
								...
								<td>
								<a href="delete/{{$locataire->id}}" onclick='return confirm("Etes vous sur de vouloir supprimer ?");'>  <button type="button"  class='btn btn-danger'>Supprimer</button></a>
								</td>
